---
title: "Mapa de infraestructura verde en Curridabat"
output: 
...
url_raster_infraestructura_verde <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/curridabat/IV_CURRIDABAT_WEB.TIF"
...
### Datos para descarga: [Capa de infraestructura verde en Curridabat](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/curridabat/IV_CURRIDABAT.TIF)
```{r}

leaflet() %>%
  setView(-84.02, (9.907672 + 9.94576)/2, 14) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Límite de Curridabat", "Infraestructura verde"),
